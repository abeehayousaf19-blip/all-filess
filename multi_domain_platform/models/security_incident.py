class SecurityIncident:
    ...
    @staticmethod
    def from_row(row: tuple) -> "SecurityIncident":
        incident_id, incident_type, severity, status, description = row
        return SecurityIncident(incident_id, incident_type, severity, status, description)
